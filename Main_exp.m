...
instruct = [ 'Stage 1: Picture recognition\n\n' ...
    ...
    'you could not initially recognize. You do \n' ...
    'not need to make any responses.' ];
[nx,ny,bbox] = displayInstruct( window, instruct, center, lnSpace, InstructionTime, pakSpace );
...
instruct = [ 'After 4 seconds spent creating this mental image, you will \n' ...
             ...
             'if the first picture was a face (F), the "k" key if the first \n' ...
             'picture was an object (O), and "l" if the first picture was a \n' ...
             'scene (S). If you are unable to imagine the correct picture, \n' ...
             'press the ";" key (?).' ];
[nx,ny,bbox] = displayInstruct( window, instruct, center, lnSpace, InstructionTime, pakSpace );
...
instruct = [ 'You will be asked to do this task 4 times for each word. \n' ...
             ...
             'visual images throughout this task. After the 4 seconds, as \n' ...
             'soon as you see the response options, try to answer as \n' ...
             'quickly and accurately as possible. If you are incorrect, \n' ...
             'you will see the correct choice marked in green, but if you \n ' ...
             'are too slow, you will miss the chance to see this feedback.' ];
[nx,ny,bbox] = displayInstruct( window, instruct, center, lnSpace, InstructionTime, pakSpace );
...
% Set the keys for picking the scale options

scaleOptions = [ 0 0 0 0 0 ];
for i = 1:300
    string = KbName(i);
    if size( string, 2 ) == 2
        if string == '1!'
...
string = [ 'During stage 4, you were asked to create vivid mental images. \n' ...
           'However, people differ in how much they mentally visualize \n' ...
           'things. Please rate on a scale the degree to which you were \n' ...
           'able to create mental images during stage 4.\n\n' ...
           '1 = I only thought of the name of the category                       \n' ...
           '2 = I very rarely mentally visualized the image                      \n' ...
           '3 = Sometimes I was able to create a mental image but not always     \n' ...
           '4 = I typically was able to create mental images                     \n' ...
           '5 = On nearly every trial I was able to create detailed mental images' ];
[ nx, ny, bbox ] = DrawFormattedText( window, string, 'center','center', [], [], [], [], 1.5, [], [] );
Screen('Flip', window);
[ mcRT, mcResp ] = getResponseMultiple( scaleOptions, 1:5, 120 );
