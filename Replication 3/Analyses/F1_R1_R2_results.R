#---------------------------------#
# Results for 1st/2nd replication #
# Kevin Potter                    #
# Updated 01/16/2018              #
#---------------------------------#
...
whichRep = 2; # Indicate which replication to plot
...
# Define path to posterior estimations
path_to_rep_results = 
  "F:/Stuff/Kevin's Stuff/Postdoc/Analyses/2017/Wimber_et_al_replication_3/Wimber_et_al_critique_appeal/Figures/R scripts/Previous replication results"
...
if ( savePlot ) {
  setwd( 'Figures' )
  if ( panelYes ) pdf( 'R1_R2_results.pdf' ) else 
    pdf( 'R1_R2_results_no_label.pdf' )
  setwd( orig_dir )
} else x11()
