...
We first conduct a posterior retrodictive check, by simulating data from the posterior estimates:
...
It is clear that there is no point in examining the coefficients, because the model is unable to account for the observed data in the first place. 